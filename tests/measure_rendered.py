...
Style: Default,Inter,46,&H00FFFFFF,&H000000FF,&H40000000,&H40000000,-1,0,0,0,100,100,0,0,3,18,0,2,54,54,127,1
...
"""
ass_path = "test_sub.ass"
with open(ass_path, "w", encoding="utf-8") as f:
    f.write(ass_content)

# 3. Render with ffmpeg
out_path = "rendered.png"
subprocess.run([
...
for y in range(1280):
    for x in range(720):
        # White is (255,255,255). The box is dark.
...
if max_x >= min_x and max_y >= min_y:
    ...
    print(f"Target CSS Dimensions: 531 x 338 px")
    print(f"Difference: Width {box_w - 531}px, Height {box_h - 338}px")
else:
